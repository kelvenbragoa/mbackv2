...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::get('promotor-tickets/{ticket}/batches', [PromotorTicketBatchController::class, 'index']);
    Route::post('promotor-tickets/{ticket}/batches', [PromotorTicketBatchController::class, 'store']);
    Route::post('promotor-tickets/{ticket}/batches/{sell}/return', [PromotorTicketBatchController::class, 'returnUnused']);
    Route::get('promotor-tickets/{ticket}/batches/{sell}/tickets', [PromotorTicketBatchController::class, 'tickets']);
    Route::get('promotor-tickets/{ticket}/batches/{sell}/pdf', [PromotorTicketBatchController::class, 'pdf']);
