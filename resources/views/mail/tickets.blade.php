{{-- <x-mail::message>
    <h1 style="text-align: center">Nova notificação da Ata de Reunião</h1>
                        ...
                        <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" class="row" width="580" style="width:580px;max-width:580px;">
                                                ...
                                                <table border="0" align="right" cellpadding="0" cellspacing="0" role="presentation" class="row" width="280" style="width:280px;max-width:280px;">
                                                    <tr  >
                                                        <td align="left" class="center-text">
                                                            <a href="{{ url('/') }}"><img style="width:100px;border:0px;display: inline!important;" src="https://mticket.co.mz/demo/images/logo2.png" width="100px" border="0"  alt="Mticket"></a>
                                                        </td>
                                                    </tr>
                                                </table>
                                                <!-- column -->
                            ...
                            <tr  >
                                <td align="center" class="center-text">
                                    <img style="width:500px;border:0px;display: inline!important;" width="500px" src="https://backend.mticket.co.mz/storage/{{$event->image}}" border="0">
                                </td>
                            </tr>
                            <tr  >
                                <td height="40" style="font-size:40px;line-height:40px;" >&nbsp;</td>
                            ...
                            <tr  >
                                <td class="center-text"  align="center" style="font-family:'Roboto Slab',Arial,Helvetica,sans-serif;font-size:26px;line-height:36px;font-weight:400;font-style:normal;color:#000000;text-decoration:none;letter-spacing:0px;">
            ...
            <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="width:100%;max-width:100%;" >
                ...
                <tr  >
                    <td align="center"  bgcolor="#FFFFFF">
                        <img style="width:50px;border:0px;display: inline!important;" src="https://mticket.co.mz/demo/images/logo2.png" width="50" border="0"       alt="arrow">
                        <br><br>
                        Este bilhete é pessoal e intrasmissivel. Por favor conserve o seu bilhete até o dia do evento.
                    </td>
                </tr>
            </table>
                        ...
                        <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" class="row" width="580" style="width:580px;max-width:580px;">
                            ...
                            <tr  >
                                <td class="center-text"  align="center" style="font-family:'Poppins',Arial,Helvetica,sans-serif;font-size:14px;line-height:24px;font-weight:400;font-style:normal;color:#6e6e6e;text-decoration:none;letter-spacing:0px;">
                                    ...
                                    <a href="tel:842648618"    style="color:#6e6e6e;"><span>+258 84 264 8618</span></a>
                                    <a href="tel:842648618"    style="color:#6e6e6e;"><span>+258 84 228 0974</span></a>
                            ...
                            <tr  >
                                <td class="center-text"  align="center" style="font-family:'Poppins',Arial,Helvetica,sans-serif;font-size:14px;line-height:24px;font-weight:400;font-style:normal;color:#6e6e6e;text-decoration:none;letter-spacing:0px;">
                                    ...
                                    <a href="mailto:suporte@mticket.co.mz"    style="color:#6e6e6e;"><span>suporte@mticket.co.mz</span></a> - <a href="{{ url('https://mticket.co.mz') }}"    style="color:#6e6e6e;"><span>{{ url('https://mticket.co.mz') }}</span></a>
